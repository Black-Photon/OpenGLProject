void stencil_example(Scene &scene, float deltaT) {
...
void lighting_example(Scene &scene, float deltaT) {
    Shader shader = scene.getShader("model");
//    shader.use();
//    scene.replaceShader(scene.getShader("solid"), shader);
//    scene.drawScene();
}